        ...
        <AnimatePresence>
            ...
            >
                ...
                <motion.div
                    ...
                    className="relative w-full max-w-lg p-[1px] rounded-3xl bg-gradient-to-br from-purple-500/40 via-blue-500/30 to-transparent"
                    onClick={(e) => e.stopPropagation()}


                >

                    <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden min-h-[520px]' >
                        <motion.div
                        ...
                        <div className='relative px-14 pt-20 pb-14 text-center flex flex-col justify-between h-full min-h-[520px]'>
                            <h1 className='inline-block mb-8 px-5 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-zinc-300'> AI-powered website builder </h1>
                            <h2 className='text-4xl font-semibold leading-tight mb-8 space-x-2'>
                             ...
                             <motion.button
                                    ...
                                    disabled={loading}
                                    className="group relative w-72 h-12 rounded-xl bg-white text-black text-base font-semibold shadow-xl overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
                                >
