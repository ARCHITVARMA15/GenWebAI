...
function Home() {
    ...
    const fallbackAvatar = `https://ui-avatars.com/api/?name=${encodeURIComponent(currentUser?.name || "User")}&background=F59E0B&color=111827&bold=true`
    ...
    return (
        <div className='relative min-h-screen bg-[#040404] text-white overflow-hidden'>
            ...
            >
                <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
                    ...
                    <div className='flex items-center gap-5'>
                        ...
                        {!currentUser ? <button className='px-4 py-2 rounded-lg border border-white/20 hover:bg-white/10 text-sm'
                        ...
                        >
                            ...
                            <div className='relative'>
                                <button className='flex items-center' onClick={() => setOpenProfile(!openProfile)}><img className='w-9 h-9 rounded-full border border-white/20 object-cover' src={currentUser?.avatar || fallbackAvatar} referrerPolicy='no-referrer' onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = fallbackAvatar }} alt="Avatar" /></button>
                                    ...
                                    {openProfile && (
                                        <>
                                            <motion.div
                                                ...
                                                className='absolute right-0 mt-2 w-48 bg-[#0b0b0b] border border-white/10 rounded-lg shadow-lg py-2 text-sm'
            ...
            <section className='pt-44 pb-32 px-6 text-center'>
                ...
                onClick={()=>navigate("/dashboard")}
                >{currentUser?"Go to Dashboard":"Get Started"}</button>
